...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'ResNet101_Dual', 'ResNet50_Dual', 'ResNet18_Dual']
...
class ResNet101_Dual(nn.Module):
    """Constructs a ResNet-101 model.
    ...
    def __init__(self, num_classes=3):
        super(ResNet101_Dual, self).__init__()
        self.model_b = ResNet(Bottleneck, [3, 4, 23, 3])
        self.model_s = ResNet(Bottleneck, [3, 4, 23, 3])
...
class ResNet50_Dual(nn.Module):
    ...
    def __init__(self, num_classes=3):
        ...
        self.model_b = ResNet(Bottleneck, [3, 4, 6, 3])
        self.model_s = ResNet(Bottleneck, [3, 4, 6, 3])
        self.fc1 = nn.Linear(4096, num_classes)
        nn.init.xavier_normal_(self.fc1.weight)
    # if pretrained:
        '''
        ...
        model.load_state_dict(model_dict)
        '''
        self.model_b.load_state_dict(model_zoo.load_url(model_urls['resnet50']), strict=False)
        self.model_s.load_state_dict(model_zoo.load_url(model_urls['resnet50']), strict=False)
...
class ResNet18_Dual(nn.Module):
    ...
    """
    def __init__(self, num_classes=3):
        super(ResNet18_Dual, self).__init__()
        self.model_b = ResNet(BasicBlock, [2, 2, 2, 2])
    ...
    # if pretrained:
        ...
        model.load_state_dict(model_dict)
        '''
        self.model_b.load_state_dict(model_zoo.load_url(model_urls['resnet18']), strict=False)
        self.model_s.load_state_dict(model_zoo.load_url(model_urls['resnet18']), strict=False)
